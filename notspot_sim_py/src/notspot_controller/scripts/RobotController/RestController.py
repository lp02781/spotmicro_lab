...
class RestController(object):
    ...
    def updateStateCommand(self, msg, state, command):
		...
		7 : R2 
        '''
        state.body_local_position[0] = msg.axes[1] * 0.04
        state.body_local_position[1] = msg.axes[0] * 0.03
        state.body_local_position[2] = msg.axes[5] * 0.03

        # local body orientation
        state.body_local_orientation[0] = msg.axes[2] * 0.4
        state.body_local_orientation[1] = msg.axes[3] * 0.5
        state.body_local_orientation[2] = msg.axes[4] * 0.4
